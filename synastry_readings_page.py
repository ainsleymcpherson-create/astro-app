...
if st.session_state.get("processing", False):
    try:
        ...
        if generate_live:
            ...
            api_effort = "medium" if quick_summary_prompt else None
        ...
        if r["interpretation_text"]:
            ...
            if r.get("want_full_now"):
                ...
                pdf_bytes = _get_or_build_pdf(
                    "synastry_reading_pdf", r["interpretation_text"], pdf_title, pdf_subtitle,
                )
                ...
                with dl_col1:
                    if pdf_bytes:
                        ...
                        st.warning(
                            "⚠️ Couldn't generate the reading PDF right now — "
                            "this is usually transient. Try again in a moment, "
                            "or use the .txt download in the meantime.",
                            icon="⚠️",
                        )
