...
IT'S NAMED IN THE OVERVIEW too, briefly: "Your core identity (the \
...
lead-in. THEN follow with a four-part structure, IN THIS ORDER:
  ...
  obvious. Four specific failures to avoid:
    ...
    (d) DEFINING THE POINT INSTEAD OF INTERPRETING IT. Explaining what \
    ...
    unchanged in anyone's reading has failed, no matter how \
    well-glossed it is. Instead of: "The South Node and Vertex sit in \
    Virgo, essentially exact on her Descendant — the angle describing \
    what she looks for in a partner and how she shows up in close \
    relationships." — that sentence never says what she looks for or \
    how she shows up, it just names the angle's job description. Write \
    something like: "Her South Node sits in Virgo, precise and \
    duty-driven. That's her comfort zone — being useful, being needed, \
    fixing what's broken. Her Vertex sits there too, almost exactly on \
    her Descendant, the angle tied to what she looks for in a partner. \
    Together, that pulls her toward partners who need fixing or \
    organizing — competence read as attraction, long before anything \
    else does." As a working test: could this exact sentence be pasted \
    into a stranger's reading without anyone noticing? If yes, it \
    defined the term instead of interpreting the chart.
...
structure, IN THIS ORDER:
  ...
  obvious. Four specific failures to avoid:
    ...
    something true about THIS person — a sentence that could appear \
    unchanged in anyone's reading has failed, no matter how \
    well-glossed it is. Instead of: "Her South Node sits in Virgo — \
    the point describing her comfort zone, the automatic patterns she \
    falls back on." — that sentence never says what her comfort zone or \
    automatic patterns actually are, it just names the point's job \
    description. Write something like: "Her South Node sits in Virgo, \
    precise and duty-driven. That's her comfort zone — being useful, \
    being needed, fixing what's broken, often before anyone even asks." \
    As a working test: could this exact sentence be pasted into a \
